...
/*
 * Fuel tile background — "Nutrient Inflow". 1:1 port of the approved verify
 * (public/tile-fuel-verify.html). A breathing core sits right-of-centre;
 * nutrient particles stream inward and are absorbed. Every 5-15s the core
 * celebrates being fed with a minimal, orb-scale version of one of the
 * gem-library bursts, never the same kind twice in a row.
 *
 ...
 *
 * Replaces the old MountainArt on Fuel (stray "PEAKING · 4 PM" + dome gone).
 */
