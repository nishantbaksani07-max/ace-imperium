...
/*
 * Finance tile background — "Candlesticks". 1:1 port of the approved verify
 * (public/tile-finance-v3.html, option A). A market candle chart over a faint
