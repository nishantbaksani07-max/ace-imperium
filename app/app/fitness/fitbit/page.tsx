...
import FitbitModule, { type FitbitView } from './FitbitModule'
...
export default async function FitbitPage() {
  ...
  // Fitbit is "coming soon" (legacy API retiring Sept 2026, registration moved
  // to Google — no shared app yet). Until a client_id exists, don't show a
  // connect button that dead-ends; send direct visits / old bookmarks back to
  // Peak, where Fitbit shows as a "Soon" tile.
  if (!process.env.FITBIT_CLIENT_ID) redirect('/app/peak')
