...
/**
 * VeeNoticed — the full "Imperium noticed" surface at §01 of the Imperium tab.
 *
 * Sits under Imperium's existing gem + greeting. Brings the loved preview to life on
...
export default function VeeNoticed({
  ...
  return (
    <section className={styles.noticed} aria-label="what Imperium noticed">
      ...
      <div className={styles.section}>
        <div className={styles.eyebrow}>
          ...
          <span className={styles.lbl}>What Imperium noticed</span>
        ...
        <div className={styles.quiet}>
          ...
          <span>Imperium is holding <b>more</b> for you. one at a time, never a wall.</span>
        </div>
      </div>
    </section>
  )
