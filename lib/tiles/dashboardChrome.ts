...
export const WALLPAPER_ACCENTS: { name: string; hex: string }[] = [
  ...
  { name: 'Sage', hex: '#A7D7B4' },
  { name: 'Seafoam', hex: '#7FE3D0' },
  { name: 'Iris', hex: '#8FA3F0' },
  { name: 'Fog', hex: '#B9C4CC' },
  { name: 'Sand', hex: '#D8C6A5' },
  { name: 'Jade', hex: '#4FBF9A' },
]
...
export const GRADIENT_PRESETS: { name: string; c1: string; c2: string; angle: number }[] = [
  ...
  { name: 'Charcoal', c1: '#15171a', c2: '#050506', angle: 168 },
  { name: 'Midnight iris', c1: '#111629', c2: '#05060c', angle: 158 },
  { name: 'Pine', c1: '#0d211b', c2: '#05100c', angle: 162 },
  { name: 'Graphite', c1: '#1c1a16', c2: '#080705', angle: 172 },
  { name: 'Nightfall', c1: '#0a1420', c2: '#03060a', angle: 152 },
  { name: 'Aurora', c1: '#0a2420', c2: '#04100e', angle: 148 },
