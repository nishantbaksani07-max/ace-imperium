...
export interface Tile {
  ...
  // When true, the tile opens as a full-page, scrollable module (Fuel-length),
  // not the default compact modal. The grid poster is unchanged either way.
  fullPage?: boolean
}
...
export interface TileEnvelope {
  ...
  fullPage?: boolean // opens as a full-page scrollable module instead of the compact modal
}
